...
db.restaurant.find( { "address.code.0": { $lt: -95.754168 } } )
...
db.restaurant.find({$or : [{ cuisine : {$nin : ['American', 'Chinese', 'Bakery', '/^Ice/']}}, {name:/^Wil/}]}, {_id:0, restaurant_id: 1, name:1, borough:1, cuisine:1 })
